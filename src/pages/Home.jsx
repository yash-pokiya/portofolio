...
import { Sparkles, Code2, ArrowUpRight, Terminal, MapPin } from 'lucide-react'
    ...
    <div className="max-w-7xl mx-auto px-8 space-y-24 pb-24">
      ...
      <section className="space-y-12">
        <div className="flex flex-col gap-4">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-3 text-indigo-500 font-bold tracking-[0.2em] uppercase text-sm">
            <Sparkles size={16} /> SY BCA Student & Logic Builder
          </motion.div>
          <motion.h1 initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} className="heading-hero">
            Turning Code <br /> Into <span className="text-indigo-500 italic">Experience.</span>
          </motion.h1>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          >
            ...
            <div className="relative z-10 flex justify-between items-start">
              <div className="flex flex-col gap-3">
                <span className="glass-tag w-fit text-indigo-500">v2.0 // Core System</span>
                <div className="flex items-center gap-2 opacity-40">
                  <div className="w-10 h-px bg-current" />
                  <span className="text-[10px] font-black uppercase tracking-[0.3em]">Architectural Logic</span>
                </div>
              </div>
              <div className="text-right flex flex-col items-end">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-40 mb-2">Build Status</p>
            ...
            <div className="relative z-10 space-y-12">
              <div className="absolute -top-12 -right-8 text-indigo-500/5 group-hover:text-indigo-500/10 transition-all duration-1000 -rotate-12 scale-75">
              ...
              <div className="flex flex-col lg:flex-row lg:items-end gap-12">
                <h2 className="text-2xl md:text-4xl font-black max-w-xl leading-tight tracking-tight text-[var(--text-main)] shrink-0">
                  ...
                  <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-500 via-purple-500 to-indigo-500 italic underline decoration-indigo-500/20 bg-[length:200%_auto] animate-[shimmer_4s_linear_infinite]">performance</span>, 
                  <span className="text-indigo-500"> elegance</span>, <br /> and 
                  <span className="text-indigo-500"> logical integrity</span>.
                </h2>

                <div className="hidden xl:flex flex-col gap-4 border-l border-black/5 dark:border-white/5 pl-8 opacity-40">
                  <p className="text-[9px] font-black uppercase tracking-[0.3em] mb-2">Core Modules</p>
                  <ul className="space-y-2 text-[10px] font-bold uppercase tracking-widest">
                    <li className="flex items-center gap-2"><span className="w-1 h-1 bg-indigo-500 rounded-full" /> Responsive Design</li>
                    <li className="flex items-center gap-2"><span className="w-1 h-1 bg-indigo-500 rounded-full" /> API Integration</li>
                    <li className="flex items-center gap-2"><span className="w-1 h-1 bg-indigo-500 rounded-full" /> Logic Building</li>
                  </ul>
                </div>
              </div>
              
              <div className="flex flex-wrap items-center gap-10 pt-4">
                <button className="btn-neo px-8 py-3">Initialize Exploration</button>
                <div className="flex items-center gap-8">
                  <div className="flex flex-col border-l border-black/10 dark:border-white/10 pl-6">
          ...
          >
            ...
            <div className="absolute bottom-10 left-10 z-20 translate-y-6 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700 delay-100">
              ...
              <div className="mt-4 h-1 w-12 bg-indigo-500 transition-all duration-700 group-hover:w-full" />
            </div>
          </motion.div>
        </div>
        ...
        <div className="flex flex-wrap gap-8 py-6 border-y border-black/5 dark:border-white/5 overflow-hidden">
          {['Logic Architecture', 'Full-Stack MERN', 'System Optimization', 'Cloud Deployment'].map((label, i) => (
            <div key={label} className="flex items-center gap-4 shrink-0">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-700 dark:text-zinc-300">{label}</span>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            <div className="flex justify-between items-start">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.3em] opacity-40">Module // 01</span>
            </div>
            <div className="mt-8">
              <p className="text-[10px] font-black uppercase tracking-[0.4em] text-indigo-500 mb-2">Current Focus</p>
              <h4 className="text-2xl font-black uppercase leading-tight">MERN Stack <br /> Mastery</h4>
            </div>
            <div className="mt-6 flex items-center gap-2">
              ...
              <span className="text-[9px] font-black opacity-40">85%</span>
            </div>
          </div>
        </motion.div>
